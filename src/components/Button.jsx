...
const Button = ({lable, theme, onPress}) => {
  ...
  if(theme === "primary") {
    return (
      <View className={"w-80 h-16 mx-5 items-center justify-center m-3 border-4 border-solid border-[#ffd33d] rounded-2xl"}>
        <Pressable className={"rounded-lg w-full h-full flex-row items-center justify-center bg-white"} onPress={onPress}>
  ...
  return (
    <View className={"w-80 h-16 mx-5 items-center justify-center p-3"}>
      <Pressable className={"rounded-lg w-full h-full flex-row items-center justify-center"} onPress={onPress}>
